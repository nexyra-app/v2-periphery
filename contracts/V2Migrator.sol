...
import '@nexyra/core/contracts/interfaces/INexyraPair.sol';
...
contract V2Migrator is IV2Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        INexyraPair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V1, uint256 amount1V1) = INexyraPair(params.pair).burn(address(this));
